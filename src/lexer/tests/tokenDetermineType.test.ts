...
describe('tokenDetermineType', () => {
  ...
  describe('Preprocessor', () => {
    describe('Directives', () => {
      assert('#include ', 0, 7, TokenCategory.prepro, TokenType.preproDirectiveInclude);
      assert(' #define PI 3.1', 1, 7, TokenCategory.prepro, TokenType.preproDirectiveDefine);
      assert('... \\\n', 4, 4, TokenCategory.prepro, TokenType.preproLineContinuation);
      assert('#undef PI', 0, 5, TokenCategory.prepro, TokenType.preproDirectiveUndef);
      assert('\n#ifdef PI', 1, 6, TokenCategory.prepro, TokenType.preproDirectiveIfdef);
      assert('#ifndef PI', 0, 6, TokenCategory.prepro, TokenType.preproDirectiveIfndef);
      assert('#if 1', 0, 2, TokenCategory.prepro, TokenType.preproDirectiveIf);
      assert('#else', 0, 4, TokenCategory.prepro, TokenType.preproDirectiveElse);
      assert('#elif', 0, 4, TokenCategory.prepro, TokenType.preproDirectiveElif);
      assert('#endif', 0, 5, TokenCategory.prepro, TokenType.preproDirectiveEndif);
      assert('#error "message"', 0, 5, TokenCategory.prepro, TokenType.preproDirectiveError);
      assert('#pragma once', 0, 6, TokenCategory.prepro, TokenType.preproDirectivePragma);
    });

    describe('Macros', () => {
      assert('__FILE__', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.preproMacroFile);
      assert('(__LINE__)', 1, 8, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.preproMacroLine);
      assert('__DATE__\n', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.preproMacroDate);
      assert('printf("%s", __TIME__);\n', 13, 20, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.preproMacroTime);
      assert('\n__TIMESTAMP__', 1, 13, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.preproMacroTimestamp);
    });
  ...
  describe('Keywords', () => {
    assert('_Alignas', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordAlignas);
    assert('alignas', 0, 6, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordAlignas);
    assert('_Alignof', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordAlignof);
    assert('alignof', 0, 6, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordAlignof);
    assert('auto', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordAuto);
    assert('_Atomic', 0, 6, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordAtomic);
    assert('atomic', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordAtomic);
    assert('_Bool', 0, 4, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordBool);
    assert('bool', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordBool);
    assert('break', 0, 4, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordBreak);
    assert('case', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordCase);
    assert('char', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordChar);
    assert('_Complex', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordComplex);
    assert('complex', 0, 6, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordComplex);
    assert('const', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordConst);
    assert('continue', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordContinue);
    assert('default', 0, 6, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordDefault);
    assert('do', 0, 1, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordDo);
    assert('double', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordDouble);
    assert('else', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordElse);
    assert('enum', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordEnum);
    assert('extern', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordExtern);
    assert('float', 0, 4, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordFloat);
    assert('for', 0, 2, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordFor);
    assert('_Generic', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordGeneric);
    assert('generic', 0, 6, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordGeneric);
    assert('goto', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordGoto);
    assert('if', 0, 1, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordIf);
    assert('_Imaginary', 0, 9, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordImaginary);
    assert('imaginary', 0, 8, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordImaginary);
    assert('int', 0, 2, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordInt);
    assert('long', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordLong);
    assert('_Noreturn', 0, 8, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordNoreturn);
    assert('noreturn', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordNoreturn);
    assert('register', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordRegister);
    assert('return', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordReturn);
    assert('short', 0, 4, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordShort);
    assert('signed', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordSigned);
    assert('sizeof', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordSizeof);
    assert('static', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordStatic);
    assert('_Static_assert', 0, 13, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordStaticassert);
    assert('static_assert', 0, 12, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordStaticassert);
    assert('struct', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordStruct);
    assert('switch', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordSwitch);
    assert('_Thread_local', 0, 13, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordThreadlocal);
    assert('thread_local', 0, 12, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordThreadlocal);
    assert('typedef', 0, 6, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordTypedef);
    assert('union', 0, 5, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordUnion);
    assert('unsigned', 0, 7, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordUnsigned);
    assert('void', 0, 3, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordVoid);
    assert('volatile', 0, 8, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordVolatile);
    assert('while', 0, 4, TokenCategory.preproMacroOrKeywordOrIdentifierOrLabel, TokenType.keywordWhile);
  });
  ...
  describe('Number', () => {
    ...
    describe('long', () => {
      ...
      assert(' 123lu\n', 1, 5, TokenCategory.constant, TokenType.constantNumber); // unsigned
      assert(' [123lU]', 2, 6, TokenCategory.constant, TokenType.constantNumber); // unsigned
      assert(' 123L)', 1, 4, TokenCategory.constant, TokenType.constantNumber);
      ...
      assert(' 0123lu*', 1, 6, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert(' 0123lU=', 1, 6, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert(' 0123L%', 1, 5, TokenCategory.constant, TokenType.constantNumber); // octal
      assert(' 0123Lu<', 1, 6, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert(' 0123LU>', 1, 6, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert(' 0x12clu!', 1, 7, TokenCategory.constant, TokenType.constantNumber); // hex
      assert(' 0x12clU|', 1, 7, TokenCategory.constant, TokenType.constantNumber); // hex unsigned
      assert(' 0X12Cu?', 1, 6, TokenCategory.constant, TokenType.constantNumber); // hex
      assert(' 0X12CU,', 1, 6, TokenCategory.constant, TokenType.constantNumber); // hex unsigned
    });
    describe('long long int', () => {
      ...
      assert('0123llu ', 0, 5, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert('0123llU ', 0, 5, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert('0123LL ', 0, 4, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert('0123LLu ', 0, 5, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert('0123LLU ', 0, 5, TokenCategory.constant, TokenType.constantNumber); // octal unsigned
      assert('0x12cll ', 0, 5, TokenCategory.constant, TokenType.constantNumber); // hex
      assert('0x12cllu ', 0, 6, TokenCategory.constant, TokenType.constantNumber); // hex unsigned
      assert('0x12cllU ', 0, 6, TokenCategory.constant, TokenType.constantNumber); // hex unsigned
      assert('0x12CLL ', 0, 5, TokenCategory.constant, TokenType.constantNumber); // hex
      assert('0x12CLLu ', 0, 6, TokenCategory.constant, TokenType.constantNumber); // hex unsigned
      assert('0x12CLLU ', 0, 6, TokenCategory.constant, TokenType.constantNumber); // hex unsigned
    ...
    describe('float', () => {
      ...
      assert(' 123.45f\n', 1, 7, TokenCategory.constant, TokenType.constantNumber);
      assert('> 123.45F)', 2, 8, TokenCategory.constant, TokenType.constantNumber);
    });
  });
  ...
  describe('Operators', () => {
    describe('Arithemtic', () => {
      ...
      assert('a+++++b', 1, 2, TokenCategory.operator, TokenType.ambiguousIncrement);
      assert('a+++++b', 3, 4, TokenCategory.operator, TokenType.ambiguousIncrement);
      ...
      assert('a-----b', 1, 2, TokenCategory.operator, TokenType.ambiguousDecrement);
      assert('a-----b', 3, 4, TokenCategory.operator, TokenType.ambiguousDecrement);
